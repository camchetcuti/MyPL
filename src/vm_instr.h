...
public:
  ...
  // Lists
  static VMInstr ALLOCL();
  static VMInstr ADDLI();
  static VMInstr SETLE();
  static VMInstr SETLI();
  static VMInstr GETLI();
  static VMInstr LNUMI();
  static VMInstr LNUMD();
  static VMInstr LNUMS();
  static VMInstr LNUMB();
  static VMInstr LRMB();
  static VMInstr LAVGI();
  static VMInstr LAVGD();
  static VMInstr LSIZE();
  static VMInstr LRETRIEVE();
  // Lists
