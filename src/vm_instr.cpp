...
// LISTS
VMInstr VMInstr::ALLOCL()
{
  return VMInstr(OpCode::ALLOCL);    
}

VMInstr VMInstr::ADDLI()
{
  return VMInstr(OpCode::ADDLI);    
}

VMInstr VMInstr::SETLE()
{
  return VMInstr(OpCode::SETLE);    
}

VMInstr VMInstr::SETLI()
{
  return VMInstr(OpCode::SETLI);    
}

VMInstr VMInstr::GETLI()
{
  return VMInstr(OpCode::GETLI);    
}

VMInstr VMInstr::LNUMI()
{
  return VMInstr(OpCode::LNUMI);    
}

VMInstr VMInstr::LNUMD()
{
  return VMInstr(OpCode::LNUMD);    
}

VMInstr VMInstr::LNUMS()
{
  return VMInstr(OpCode::LNUMS);    
}

VMInstr VMInstr::LNUMB()
{
  return VMInstr(OpCode::LNUMB);    
}

VMInstr VMInstr::LRMB()
{
  return VMInstr(OpCode::LRMB);    
}

VMInstr VMInstr::LAVGI()
{
  return VMInstr(OpCode::LAVGI);    
}

VMInstr VMInstr::LAVGD()
{
  return VMInstr(OpCode::LAVGD);    
}

VMInstr VMInstr::LSIZE()
{
  return VMInstr(OpCode::LSIZE);    
}

VMInstr VMInstr::LRETRIEVE()
{
  return VMInstr(OpCode::LRETRIEVE);    
}
...
std::string to_string(const VMInstr& instr)
{
  std::unordered_map<OpCode, string> os = {
    ...
    {OpCode::NOP, "NOP"}, {OpCode::ALLOCL, "ALLOCL"},
    {OpCode::ADDLI, "ADDLI"}, {OpCode::SETLI, "SETLI"},
    {OpCode::GETLI, "GETLI"}, {OpCode::SETLE, "SETLE"},
    {OpCode::LNUMI, "LNUMI"}, {OpCode::LNUMD, "LNUMD"},
    {OpCode::LNUMS, "LNUMS"}, {OpCode::LNUMB, "LNUMB"},
    {OpCode::LRMB, "LRMB"}, {OpCode::LAVGI, "LAVGI"},
    {OpCode::LAVGD, "LAVGD"}, {OpCode::LSIZE, "LSIZE"},
    {OpCode::LRETRIEVE, "LRETRIEVE"}
  };
  string vstr = "";
